...
import WhyClayBackground from "@/components/background-animations/why-clay-bg"

export default function Slide6WhyClay() {
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-4xl font-bold mb-4 text-slate-800">Why We Use Clay</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            {benefits.map((benefit, index) => (
              ...
              >
                <div className="bg-amber-600/10 p-2 rounded-full">
                  <div className="w-6 h-6 bg-amber-600 rounded-full flex items-center justify-center text-white font-bold">
                    {index + 1}
                  </div>
                </div>
                <div>
                  <h3 className="text-xl font-semibold mb-1 text-slate-800">{benefit.title}</h3>
          ...
          >
            ...
            <motion.div
              ...
              className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-amber-600/90 to-transparent p-6"
            >
